  ...
  return (
    <main className="page-shell auth-shell">
      <section className="auth-container card">
        ...
        <h1>Welcome back</h1>
        <p className="auth-subtext">Log in to continue editing your latest CV and cover letter.</p>
        ...
        <div className="auth-buttons">
          <button type="button" className="auth-button btn-email" onClick={onLogInEmail}>
            <MailIcon />
        ...
        <button type="button" className="text-button auth-switch-link" onClick={onGoToSignUp}>
